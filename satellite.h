...
#ifndef GEOMETRY_SATELLITE_H
#define GEOMETRY_SATELLITE_H
...
public:
    // ctor/dtor
    Satellite(float radius = 1.0f, int sectorCount = 36, int stackCount = 18, bool smooth = true, int up = 3);
    ~Satellite() {}
    ...
    void draw(std::vector<float> centerPoint, float radius, std::string TLE) const;                                  // draw surface
